...
class MainPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.kg_label.grid(row=5, column=0, padx=0, pady=0, ipadx=0, ipady=10, sticky=tk.W)
        ...
        self.frame.grid(row=7, column=0, padx=0, pady=400, ipadx=0, ipady=0, sticky=tk.NE)
...
# def __init__(self, parent, title, message, theme):
        ...
        self.page_button = tk.Button(self.frame, text="SBD performances", command=lambda: controller.show_frame("SecondPage"))
...
class SecondPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.back_button = tk.Button(self, text="return to the 1rm calculator", command=lambda: controller.show_frame("MainPage"))
        self.back_button.grid(row=3, column=1, padx=10, pady=10, ipadx=0, ipady=0, sticky=tk.NE)
    ...
    def save_perf(self):
        ...
        if move and weight:
            try:
                ...
                print(date)
                with open(f'{move.lower()}_performance.csv', 'a', newline='') as file:
...
class ShowGraph(tk.Toplevel):
    ...
    def plot_graph(self):
        ...
        weights = []
        try:
            with open(f'{self.move.lower()}_performance.csv', 'r') as file:
            ...
            if not dates or not weights:
                tk.messagebox.showerror("Error", f"No valid data found for {self.move}.")
                return
